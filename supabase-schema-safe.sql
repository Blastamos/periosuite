...
DROP POLICY IF EXISTS "Users can manage own patient charts" ON perio_charts;
DROP POLICY IF EXISTS "Users can manage own patient assessments" ON assessments;
DROP POLICY IF EXISTS "Only admin can manage OTP" ON otp_tokens;
